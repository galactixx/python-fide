...
from python_fide.clients._base import AsyncFideClient
...
class AsyncFidePlayerClient(AsyncFideClient):
    """
    An asynchronous Fide player client to pull all player specific data
    ...
    async def get_opponents(self, player: FidePlayerLike) -> List[FidePlayer]:
        """
